...
import (
	...
	"practice.com/go/rest-ws/handlers"
	"practice.com/go/rest-ws/middleware"
	"practice.com/go/rest-ws/server"
)
...
func BindRoutes(s server.Server, r *mux.Router) {
	...
	r.HandleFunc("/home", handlers.HomeHandler(s)).Methods(http.MethodGet)
